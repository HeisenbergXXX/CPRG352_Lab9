...
<html>
    ...
    <body>
        ...
        <c:if test="${action != null}">
            <div>
                <h2>
                    <c:if test="${action == 'addUser'}">Add User</c:if>
                    <c:if test="${action != 'addUser'}">Edit User ${email}</c:if>
                </h2>
                <form action="user" method="POST">
                    <table class="add">
                        <c:if test="${action == 'addUser'}">
                            <tr>
                                <td>
                            ...
                            <td>
                                <select name="role" class="drop">
                                    <c:forEach items="${roles}" var="roleN">
                                        <option value="${roleN.roleId}" <c:if test="${roleN.roleId eq role.roleId}">selected</c:if>>${roleN.roleName}</option>
                                    </c:forEach>
                                </select>
                            </td>
                        </tr>
